...
if __name__ == '__main__':
    ...
    if not exists(saved_agent_file_name):
        ...
        # setting all of them to stop learning
        ...
        for i in range(num_switches):
            ...
            if (i + 1) % 20 == 0:
                ...
                with open(saved_agent_file_name, "wb") as f:
                    dump(player1, f)
        ...
        # copy all of them
        with open(saved_agent_file_name, "rb") as f:
            standard_player = load(f)


        player1 = deepcopy(standard_player)
        player2 = deepcopy(standard_player)
        player3 = deepcopy(standard_player)
        player4 = deepcopy(standard_player)
